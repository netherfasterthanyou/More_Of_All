...
public class ThrowingAxeProjectileEntity extends AbstractArrow {
    private float rotation;
    public Vec2 groundedOffset;

    public ThrowingAxeProjectileEntity(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }
    public ThrowingAxeProjectileEntity(LivingEntity shooter, Level level){
        super(ModEntities.THROWING_AXE.get(), shooter, level, new ItemStack(modItems.THROWING_AXE.get()), null);
    }
